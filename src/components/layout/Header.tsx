    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90">
      <div className="container mx-auto flex h-24 items-center justify-between px-8 ">
        ...
        <Link href="/pendaftaran">
            <div className="header-cta rounded-md bg-pmi-red px-6 py-3 text-sm font-semibold text-pmi-red transition-colors duration-200 shadow-md hover:shadow-black/60">
                DAFTAR
            </div>
        </Link>
      </div>
